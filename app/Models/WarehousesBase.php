...
class WarehousesBase extends Model
{
    ...
    protected $validationRules = [
        ...
        'type'          => 'permit_empty|in_list[EXTERNO,INTERNO,EXTERNA,INTERNA]',
    ...
    public function getWarehousesWithDetails(): array
    {
        return $this->select('warehouses_base.id, warehouses_base.name, warehouses_base.state, warehouses_base.type, warehouses_base.id_user_admin, warehouses_base.id_user_admin as admin, warehouses_base.id_client, warehouses_base.id_client as titular, warehouses_base.created_at, warehouses_base.updated_at, u.name as admin_name, u.email as admin_email, c.nombre_cliente as client_name, COUNT(b.id) as total_items')
            ...
            ->groupBy('warehouses_base.id, warehouses_base.name, warehouses_base.state, warehouses_base.type, warehouses_base.id_user_admin, warehouses_base.id_client, warehouses_base.created_at, warehouses_base.updated_at, u.name, u.email, c.nombre_cliente')
